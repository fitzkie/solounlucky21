  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-black text-white antialiased">
        <header className="border-b border-white/10 px-4 py-4 sticky top-0 z-50 bg-black/95 backdrop-blur">
          <div className="max-w-6xl mx-auto flex items-center gap-5">
            <a href="/" className="flex items-center gap-3 shrink-0">
              <img src="/logo.png" alt="Unlucky21" className="w-12 h-12 rounded-full" />
              <span className="font-black tracking-tight text-white text-base hidden md:block">UNLUCKY21</span>
            </a>
            ...
            <div className="flex items-center gap-1 shrink-0 ml-1">
              <a
                ...
                aria-label="Telegram"
                className="p-2 rounded-lg text-white/40 hover:text-[#229ED9] hover:bg-white/5 transition-colors"
              >
