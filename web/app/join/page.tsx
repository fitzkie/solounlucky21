...
export default function JoinPage() {
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div>
        <h1 className="text-3xl font-black">Connect Your Miner &amp; Join Unlucky21</h1>
      ...
      <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-6 space-y-3">
        <p className="text-sm text-white/70 leading-relaxed">
          You&apos;re not joining a pool where all workers share a proportional cut of every block.
          Unlucky21 is a different game: <strong className="text-white">only 21 addresses get paid</strong> — the ones
          who submitted the highest-difficulty shares. Your Bitcoin address is your identity.
          No registration, no account, no custody. Point your miner, get in the 21, and wait.
        </p>
        <p className="text-xs text-white/40 leading-relaxed">
          The moment you submit a share that lands you in the top 21, you hold a payout slot.
          You can stop mining and come back to check. If a block is found while you&apos;re on the list,
          your address gets paid — automatically, in the coinbase transaction, no action required.
        </p>
      </div>
